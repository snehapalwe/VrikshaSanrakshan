<?php
define("DEFAULT_TIMEZONE", "Asia/Kolkata"); // set php date functions timezone
define("DEVELOPMENT_MODE" , 0);// set to false when in production
error_reporting(0);
$xDSSConfig=json_decode(file_get_contents("config_Website_dss.json"),true);
if($xDSSConfig['on_off']=="OFF"){ 
   echo "Website Down";
   exit();  
}

foreach($xDSSConfig as $key=>$value){
...
define("SITE_NAME", "KDMC - Tree Cutting Permission ");
...
define("APP_ID", "b761abb82a91b2fa91cdc7dc4ed70fe8");
...
define("DB_USERNAME", "singlewindowsyst_kdmc_tree");
define("DB_PASSWORD", "kdmc_tree");
define("DB_NAME", "singlewindowsyst_kdmc_tree");

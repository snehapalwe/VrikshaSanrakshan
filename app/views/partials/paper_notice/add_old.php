...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Paper Notice</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="paper_notice-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("paper_notice/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <input id="ctrl-rec_id"  value="<?php  echo $this->set_field_value('rec_id',""); ?>" type="hidden" placeholder="Enter Rec Id"  readonly required="" name="rec_id"  class="form-control " />
                                    <div class="form-group ">
                                        ...
                                        <div id="ctrl-upload_paper_cutting-holder" class=""> 
                                            <div class="dropzone required" input="#ctrl-upload_paper_cutting" fieldname="upload_paper_cutting"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                <input name="upload_paper_cutting" id="ctrl-upload_paper_cutting" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('upload_paper_cutting',""); ?>" type="text"  />
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-name_of_news_paper-holder" class=""> 
                                                <select required=""  id="ctrl-name_of_news_paper" name="name_of_news_paper"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    $selected = $this->set_field_selected('name_of_news_paper',$value, "");
                                                    ?>

...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Occupancy Certificate</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("occupancy_certificate/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="cc_number">CC NUMBER  </label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-cc_number"  value="<?php  echo $data['cc_number']; ?>" type="number" placeholder="Enter Cc Number" step="1"  name="cc_number"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                                            ...
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <div class="form-group ">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="">
                                                                                                <input id="ctrl-architect_pin_code"  value="<?php  echo $data['architect_pin_code']; ?>" type="number" placeholder="Enter Architect Pin Code" step="1"  required="" name="architect_pin_code"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group ">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-sm-8">
                                                                                                <div class="">
                                                                                                    <input id="ctrl-architect_mobile_number"  value="<?php  echo $data['architect_mobile_number']; ?>" type="number" placeholder="Enter Architect Mobile Number" min="1000000000" max="9999999999" step="1"  required="" name="architect_mobile_number"  class="form-control " />
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div class="form-group ">
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-sm-8">
                                                                                                            <div class="">
                                                                                                                <input id="ctrl-builder_pin_code"  value="<?php  echo $data['builder_pin_code']; ?>" type="number" placeholder="Enter Builder Pin Code" step="1"  required="" name="builder_pin_code"  class="form-control " />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="form-group ">
                                                                                                        <div class="row">
                                                                                                            ...
                                                                                                            <div class="col-sm-8">
                                                                                                                <div class="">
                                                                                                                    <input id="ctrl-builder_mobile_number"  value="<?php  echo $data['builder_mobile_number']; ?>" type="number" placeholder="Enter Builder Mobile Number" min="1000000000" max="9999999999" step="1"  required="" name="builder_mobile_number"  class="form-control " />
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="form-group ">
                                                                                                            ...
                                                                                                            <div class="form-group ">
                                                                                                                <div class="row">
                                                                                                                    <div class="col-sm-4">
                                                                                                                        <label class="control-label" for="building_area_oc_in_sq_mtr">BUILDING AREA (OC) IN SQ.M  <span class="text-danger">*</span></label>
                                                                                                                    </div>
                                                                                                                    <div class="col-sm-8">
                                                                                                                        <div class="">
                                                                                                                            <input id="ctrl-building_area_oc_in_sq_mtr"  value="<?php  echo $data['building_area_oc_in_sq_mtr']; ?>" type="text" placeholder="Enter Building Area Oc In Sq Mtr"  required="" name="building_area_oc_in_sq_mtr"  class="form-control " />
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="form-group ">
                                                                                                                    ...
                                                                                                                    <div class="form-group ">
                                                                                                                        <div class="row">
                                                                                                                            <div class="col-sm-4">
                                                                                                                                <label class="control-label" for="architech_application">ARCHITECT APPLICATION  <span class="text-danger">*</span></label>
                                                                                                                            </div>
                                                                                                                            <div class="col-sm-8">
                                                                                                                                <div class="">
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-8">
                                                                                                                                        <div class="">
                                                                                                                                            <div class="dropzone required" input="#ctrl-document_7_12" fieldname="document_7_12"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg,.pdf" filesize="3" maximum="1">
                                                                                                                                                <input name="document_7_12" id="ctrl-document_7_12" required="" class="dropzone-input form-control" value="<?php  echo $data['document_7_12']; ?>" type="text"  />
                                                                                                                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                                                    <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                            <?php Html :: uploaded_files_list($data['document_7_12'], '#ctrl-document_7_12'); ?>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                                <div class="form-group ">
                                                                                                                                    <div class="row">
                                                                                                                                        <div class="col-sm-4">
                                                                                                                                            <label class="control-label" for="tree_plantation_noc_old">TREE PLANTATION NOC OLD  <span class="text-danger">*</span></label>
                                                                                                                                        </div>
                                                                                                                                        <div class="col-sm-8">
                                                                                                                                            <div class="">
                                                                                                                                                <div class="dropzone required" input="#ctrl-tree_plantation_noc_old" fieldname="tree_plantation_noc_old"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg,.pdf" filesize="3" maximum="1">
                                                                                                                                                    <input name="tree_plantation_noc_old" id="ctrl-tree_plantation_noc_old" required="" class="dropzone-input form-control" value="<?php  echo $data['tree_plantation_noc_old']; ?>" type="text"  />
                                                                                                                                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                                                        <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                                <?php Html :: uploaded_files_list($data['tree_plantation_noc_old'], '#ctrl-tree_plantation_noc_old'); ?>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                    <div class="form-group ">
                                                                                                                                        <div class="row">
                                                                                                                                            <div class="col-sm-4">
                                                                                                                                                <label class="control-label" for="town_planning_cc_copy_rdp_copy">TOWN PLANNING CC COPY  <span class="text-danger">*</span></label>
                                                                                                                                            </div>
                                                                                                                                            <div class="col-sm-8">
                                                                                                                                                <div class="">
                                                                                                                                                    <div class="dropzone required" input="#ctrl-town_planning_cc_copy_rdp_copy" fieldname="town_planning_cc_copy_rdp_copy"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg,.pdf" filesize="3" maximum="1">
                                                                                                                                                        <input name="town_planning_cc_copy_rdp_copy" id="ctrl-town_planning_cc_copy_rdp_copy" required="" class="dropzone-input form-control" value="<?php  echo $data['town_planning_cc_copy_rdp_copy']; ?>" type="text"  />
                                                                                                                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                                                            <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                    <?php Html :: uploaded_files_list($data['town_planning_cc_copy_rdp_copy'], '#ctrl-town_planning_cc_copy_rdp_copy'); ?>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                        <div class="form-group ">
                                                                                                                                            <div class="row">
                                                                                                                                                ...
                                                                                                                                                <div class="col-sm-8">
                                                                                                                                                    <div class="">
                                                                                                                                                        <div class="dropzone required" input="#ctrl-oc_affidavit" fieldname="oc_affidavit"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                                                                                                                            <input name="oc_affidavit" id="ctrl-oc_affidavit" required="" class="dropzone-input form-control" value="<?php  echo $data['oc_affidavit']; ?>" type="text"  />
                                                                                                                                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                                                                <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                                                            </div>
                                                                                                                                                        </div>
                                                                                                                                                        <?php Html :: uploaded_files_list($data['oc_affidavit'], '#ctrl-oc_affidavit'); ?>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                            <div class="form-group ">
                                                                                                                                                <div class="row">
                                                                                                                                                    <div class="col-sm-4">
                                                                                                                                                        <label class="control-label" for="cc_certificate_copy">CC CERTIFICATE COPY  </label>
                                                                                                                                                    </div>
                                                                                                                                                    <div class="col-sm-8">
                                                                                                                                                        <div class="">
                                                                                                                                                            <div class="dropzone " input="#ctrl-cc_certificate_copy" fieldname="cc_certificate_copy"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="1">
                                                                                                                                                                <input name="cc_certificate_copy" id="ctrl-cc_certificate_copy" class="dropzone-input form-control" value="<?php  echo $data['cc_certificate_copy']; ?>" type="text"  />
                                                                                                                                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                                                                    <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                                                                </div>
                                                                                                                                                            </div>
                                                                                                                                                            <?php Html :: uploaded_files_list($data['cc_certificate_copy'], '#ctrl-cc_certificate_copy'); ?>
                                                                                                                                                        </div>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            </div>

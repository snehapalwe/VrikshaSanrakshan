                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-building_area_oc_in_sq_mtr">
                                        <th class="title"> Building Area Oc In Sq Mtr: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['building_area_oc_in_sq_mtr']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("occupancy_certificate/editfield/" . urlencode($data['oc_id'])); ?>" 
                                                data-name="building_area_oc_in_sq_mtr" 
                                                data-title="Enter Building Area Oc In Sq Mtr" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
                                                data-showbuttons="left" 
                                                class="is-editable" <?php } ?>>
                                                <?php echo $data['building_area_oc_in_sq_mtr']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    <tr  class="td-tree_plantation_noc_old">
                                        <th class="title"> Tree Plantation Noc Old: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['tree_plantation_noc_old']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("occupancy_certificate/editfield/" . urlencode($data['oc_id'])); ?>" 
                                                data-name="tree_plantation_noc_old" 
                                                data-title="Browse..." 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                ...
                                                data-showbuttons="left" 
                                                class="is-editable" <?php } ?>>
                                                <?php echo $data['tree_plantation_noc_old']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    <tr  class="td-town_planning_cc_copy_rdp_copy">
                                        <th class="title"> Town Planning Cc Copy Rdp Copy: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['town_planning_cc_copy_rdp_copy']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("occupancy_certificate/editfield/" . urlencode($data['oc_id'])); ?>" 
                                                data-name="town_planning_cc_copy_rdp_copy" 
                                                data-title="Browse..." 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                ...
                                                data-showbuttons="left" 
                                                class="is-editable" <?php } ?>>
                                                <?php echo $data['town_planning_cc_copy_rdp_copy']; ?> 
                                            </span>
                                        </td>
                                    </tr>
                                    <tr  class="td-status">
                                    ...
                                    <tr  class="td-cc_certificate_copy">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['cc_certificate_copy']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("occupancy_certificate/editfield/" . urlencode($data['oc_id'])); ?>" 
                                                data-name="cc_certificate_copy" 
                                                data-title="Browse..." 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                ...
                                                data-showbuttons="left" 
                                                class="is-editable" <?php } ?>>
                                                <?php echo $data['cc_certificate_copy']; ?> 
                                            </span>
                                        </td>
                                    </tr>

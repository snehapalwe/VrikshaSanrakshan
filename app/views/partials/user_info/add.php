...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New User Info</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="user_info-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("user_info/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <label class="control-label" for="username">USERNAME  <span class="text-danger">*</span></label>
                                    <div id="ctrl-username-holder" class=""> 
                                        <input id="ctrl-username"  value="<?php  echo $this->set_field_value('username',""); ?>" type="text" placeholder="Enter Username"  required="" name="username"  data-url="api/json/user_info_username_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-ward-holder" class=""> 
                                                    <input id="ctrl-ward"  value="<?php  echo $this->set_field_value('ward',""); ?>" type="text" placeholder="Enter Ward"  required="" name="ward"  class="form-control " />
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label class="control-label" for="mobile_number">MOBILE NUMBER  <span class="text-danger">*</span></label>
                                                    <div id="ctrl-mobile_number-holder" class=""> 
                                                        <input id="ctrl-mobile_number"  value="<?php  echo $this->set_field_value('mobile_number',""); ?>" type="number" placeholder="Enter Mobile Number" min="9999999999" max="1000000000" step="1"  required="" name="mobile_number"  class="form-control " />
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div id="ctrl-applicant_address-holder" class=""> 
                                                                <textarea placeholder="Enter Applicant Address" id="ctrl-applicant_address"  required="" rows="5" name="applicant_address" class=" form-control"><?php  echo $this->set_field_value('applicant_address',""); ?></textarea>

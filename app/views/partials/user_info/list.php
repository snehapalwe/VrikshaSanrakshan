...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">User Info</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-mobile_number"> Mobile Number</th>
                                                <th  class="td-applicant_full_name"> Applicant Full Name</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-ward"> <?php echo $data['ward']; ?></td>
                                                <td class="td-mobile_number"> <?php echo $data['mobile_number']; ?></td>
                                                <td class="td-applicant_full_name"> <?php echo $data['applicant_full_name']; ?></td>

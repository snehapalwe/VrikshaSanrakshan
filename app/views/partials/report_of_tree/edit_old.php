...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Report Of Tree</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("report_of_tree/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <div class="dropzone required" input="#ctrl-upload_photo_of_plantation" fieldname="upload_photo_of_plantation"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                                <input name="upload_photo_of_plantation" id="ctrl-upload_photo_of_plantation" required="" class="dropzone-input form-control" value="<?php  echo $data['upload_photo_of_plantation']; ?>" type="text"  />
                                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                    <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                </div>
                                                            </div>
                                                            <?php Html :: uploaded_files_list($data['upload_photo_of_plantation'], '#ctrl-upload_photo_of_plantation'); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <div class="dropzone required" input="#ctrl-upload_photo_of_tree_now" fieldname="upload_photo_of_tree_now"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                                    <input name="upload_photo_of_tree_now" id="ctrl-upload_photo_of_tree_now" required="" class="dropzone-input form-control" value="<?php  echo $data['upload_photo_of_tree_now']; ?>" type="text"  />
                                                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                        <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                    </div>
                                                                </div>
                                                                <?php Html :: uploaded_files_list($data['upload_photo_of_tree_now'], '#ctrl-upload_photo_of_tree_now'); ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

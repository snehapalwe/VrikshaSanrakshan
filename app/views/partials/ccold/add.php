...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Commencement Certificate</h4>
                </div>
            </div>
        </div>
    </div>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div id="ctrl-no_of_trees_if_available-holder" class=""> 
                                                                        <input id="ctrl-no_of_trees_if_available"  value="<?php  echo $this->set_field_value('no_of_trees_if_available',""); ?>" type="number" placeholder="Enter No Of Trees" step="1" MIN="1" required="" name="no_of_trees_if_available"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div class="form-group ">
                                                                                ...
                                                                                <div id="ctrl-architect_pin_code-holder" class=""> 
                                                                                    <input id="ctrl-architect_pin_code"  value="<?php  echo $this->set_field_value('architect_pin_code',""); ?>" type="text" placeholder="Enter Architect Pin Code"  required="" name="architect_pin_code"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group ">
                                                                                    ...
                                                                                    <div id="ctrl-architect_mobile_number-holder" class=""> 
                                                                                        <input id="ctrl-architect_mobile_number"  value="<?php  echo $this->set_field_value('architect_mobile_number',""); ?>" type="number" placeholder="Enter Architect Mobile Number" maxlength="9999999999" minlength="1000000000" min="1000000000" max="9999999999" step="1"  required="" name="architect_mobile_number"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div class="form-group ">
                                                                                            ...
                                                                                            <div class="form-group ">
                                                                                                ...
                                                                                                <div id="ctrl-builder_pin_code-holder" class=""> 
                                                                                                    <input id="ctrl-builder_pin_code"  value="<?php  echo $this->set_field_value('builder_pin_code',""); ?>" type="text" placeholder="Enter Builder Pin Code"  required="" name="builder_pin_code"  class="form-control " />
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="form-group ">
                                                                                                    ...
                                                                                                    <div id="ctrl-builder_mobile_number-holder" class=""> 
                                                                                                        <input id="ctrl-builder_mobile_number"  value="<?php  echo $this->set_field_value('builder_mobile_number',""); ?>" type="number" placeholder="Enter Builder Mobile Number" maxlength="9999999999" minlength="1000000000" min="1000000000" max="9999999999" step="1"  required="" name="builder_mobile_number"  class="form-control " />
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="form-group ">
                                                                                                        ...
                                                                                                        <div id="ctrl-plot_area_in_sq_mtr-holder" class=""> 
                                                                                                            <input id="ctrl-plot_area_in_sq_mtr"  value="<?php  echo $this->set_field_value('plot_area_in_sq_mtr',""); ?>" type="number" placeholder="Enter Plot Area In Sq Mtr" step="1"  required="" name="plot_area_in_sq_mtr"  class="form-control " />
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="form-group ">
                                                                                                            ...
                                                                                                            <div class="form-group ">
                                                                                                                ...
                                                                                                                <div id="ctrl-architech_application-holder" class=""> 
                                                                                                                    <div class="dropzone required" input="#ctrl-architech_application" fieldname="architech_application"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg,.pdf" filesize="3" maximum="1">
                                                                                                                        <input name="architech_application" id="ctrl-architech_application" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('architech_application',""); ?>" type="text"  />
                                                                                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                            <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                        </div>
                                                                                                                    </div>
...
<script>
    $.getJSON("https://singlewindowsystemkdmc.in/api/common/commencement_certificate/<?php echo USER_NAME ?>",function(data){
        
							 data.forEach(function (group, index) 
							{
       $("#ctrl-"+group.field).val(group.value);if(group.value!=""){
           $("#ctrl-"+group.field).prop("readonly",true);
			   $("#ctrl-"+group.field).css('pointer-events','none');
       }
       if (group.value.startsWith("http://") || group.value.startsWith("https://")) {
         
       $("#ctrl-"+group.field).parents(".form-group").hide();
        }

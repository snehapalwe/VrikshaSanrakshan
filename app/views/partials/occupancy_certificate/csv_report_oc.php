            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn page-content">
                        ...
                        $records = $db->get("occupancy_certificate");
                        /* =====================
                        BUILD CSV DATA
                        ===================== */
                        $csvData = "\xEF\xBB\xBF";
                        $csvData .= "Sr No,BPMS Project Code,Application No,Applicant Name,Survey No,Application Date,Commencement Certificate No,Area (Sq Mtr),List of Planted Trees,Total Trees,Tree Plantation Registration No\n";
                        $sr = 1;
                        foreach($records as $row){
                        $app_date = date("jS F Y", strtotime($row['date']));
                        $noc_date = date("jS F Y", strtotime($row['updated_timestamp']));
                        $noc = "जा.क्र.कडोंमपा/उद्यान/वृअ/वृप्रा/".$row['outward_oc']." (".$noc_date.")";
                        $csvData .= $sr.",,"
                        .$row['application_no'].","
                        ...
                        ."\"".$row['name_of_trees_to_be_planted']."\","
                        .$row['number_of_trees_to_be_planted'].","
                        ."\"".$noc."\"\n";
                        $sr++;
                        }
                        ?>
                        ...
                        <html>
                            <head>
                                <meta charset="UTF-8">
                                    <title>Occupancy Certificate Report</title>
                                    <style>
                                        body{
                                ...
                                <body>
                                    <h2 style="color:#003366;">OCCUPANCY CERTIFICATE REPORT</h2>
                                    <br>
                                            ...
                                            <input type="date" name="from_date" value="<?= htmlspecialchars($from_date) ?>">
                                                ...
                                                <table class="table">
                                                    <tr>
                                                        ...
                                                        <th>Planted Trees</th>
                                                        <th>Total Trees</th>
                                                        <th>Tree Plantation Registration No</th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $app_date ?></td>
                                                        <td><?= htmlspecialchars($row['cc_number']) ?></td>
                                                        <td class="right"><?= $row['plot_area_in_sq_mtr'] ?></td>
                                                        <td><?= htmlspecialchars($row['name_of_trees_to_be_planted']) ?></td>
                                                        <td class="center"><?= $row['number_of_trees_to_be_planted'] ?></td>
                                                        <td><?= $noc ?></td>
                                                    </tr>
                                                    <?php $sr++; ?>
                                                    <?php endforeach; ?>
                                                    <?php else: ?>
                                                    <tr>
                                                        <td colspan="10" class="center" style="padding:30px;">No Records Found</td>
                                                    </tr>
                                                    <?php endif; ?>
                                                </table>
                                                <script>
                                                    ...
                                                    link.download = "occupancy_certificate_report.csv";

                            ...
                            <div> 
                                <div class="form-group ">
                                    ...
                                    <div id="ctrl-cc_number-holder" class=""> 
                                        <input id="ctrl-cc_number"  value="<?php  echo $this->set_field_value('cc_number',""); ?>" type="text" placeholder="ENTER CC APPLICATION NUMBER"  required="" name="cc_number"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-mobile_no-holder" class=""> 
                                                <input id="ctrl-mobile_no"  value="<?php  echo $this->set_field_value('mobile_no',""); ?>" type="number" placeholder="ENTER MOBILE NUMBER" min="1000000000" max="9999999999" step="1"  required="" name="mobile_no"  class="form-control " />
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div id="ctrl-architech_name-holder" class=""> 
                                                                            <input id="ctrl-architech_name"  value="<?php  echo $this->set_field_value('architech_name',""); ?>" type="text" placeholder="ENTER ARCHITECT NAME"  required="" name="architech_name"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group ">
                                                                                                        ...
                                                                                                        <div class="form-group ">
                                                                                                            ...
                                                                                                            <div class="form-group ">
                                                                                                                ...
                                                                                                                <div id="ctrl-survey_no-holder" class=""> 
                                                                                                                    <input id="ctrl-survey_no"  value="<?php  echo $this->set_field_value('survey_no',""); ?>" type="text" placeholder="ENTER SURVEY NUMBER"  required="" name="survey_no"  class="form-control " />
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="form-group ">
                                                                                                                    ...
                                                                                                                    <div class="form-group ">
                                                                                                                        ...
                                                                                                                        <div class="form-group ">
                                                                                                                            ...
                                                                                                                            <div class="form-group ">
                                                                                                                                <label class="control-label" for="document_7_12">7/12 DOCUMENT / PLOT PLAN <span class="text-danger">*</span></label>
                                                                                                                                ...
                                                                                                                                <div class="form-group">
                                                                                                                                    <label class="control-label" for="oc_affidavit">UPLOAD CC <span class="text-danger">*</span></label>
...
foreach($fmap as $f){
    ?>
    $("#ctrl-<?php echo $f['oc'] ?>").val("<?php echo $rec[$f['cc']] ?>");
    $("#ctrl-<?php echo $f['oc'] ?>").prop("readonly",true);
    $("#ctrl-<?php echo $f['oc'] ?>").css("pointer-events","none");
    <?php
}
}
?>

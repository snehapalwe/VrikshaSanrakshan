...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Inspection</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="inspection-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("inspection/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                ...
                                <div class="row ">
                                    <div class="col-md-12 comp-grid">
                                        <div class=""><Script>
                                            ...
                                            let datePickr = $('#ctrl-date').flatpickr({altInput: true,
                                            altFormat: "d-m-Y",
                                            dateFormat: "Y-m-d" });
                                            console.log(data);

                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-order_date">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-flatpickr="{ enableTime: false, minDate: '', maxDate: '<?php echo date_now(); ?>'}" 
                                                ...
                                                data-title="Enter Order Date/मागणीची तारीख" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                    ...
                                    <tr  class="td-upload_order">
                                        <th class="title"> Upload Order: </th>
                                        <td class="value"><?php Html :: page_link_file($data['upload_order']); ?></td>
                                    </tr>

                                ...
                                <div id="page-report-body" class="table-responsive">
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                <th class="td-sno">#</th>
                                                <th  class="td-order_date"> Order Date/मागणीची तारीख</th>
                                                <th  class="td-upload_order"> Upload Order/ऑर्डर अपलोड करा</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-order_date"> <?php echo $data['order_date']; ?></td>
                                                <td class="td-upload_order"> <?php echo $data['upload_order']; ?></td>

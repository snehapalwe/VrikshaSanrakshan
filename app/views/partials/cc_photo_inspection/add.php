...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="cc_photo_inspection-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("cc_photo_inspection/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-upload_photo_of_tree-holder" class=""> 
                                                    <div class="dropzone required" input="#ctrl-upload_photo_of_tree" fieldname="upload_photo_of_tree"    data-multiple="true" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg,.pdf" filesize="15" maximum="7">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div id="ctrl-name_of_tree-holder" class=""> 
                                                        <select required=""  id="ctrl-name_of_tree" name="name_of_tree"  placeholder="Select a value ..."    class="selectize" >
                                                            <option value="">Select a value ...</option>
                                                            <?php 
                                                            $name_of_tree_options = $comp_model -> cc_photo_inspection_name_of_tree_option_list();
                                                ...
                                                <div class="form-group "  >
                                                    <label class="control-label" for="enter_name_of_tree">ENTER NAME OF TREE <span class="text-danger">*</span></label>
                                                    <div id="ctrl-enter_name_of_tree-holder" class=""> 
                                                        <input id="ctrl-enter_name_of_tree"  value="<?php  echo $this->set_field_value('enter_name_of_tree',""); ?>" type="text" placeholder="Enter Enter Name Of Tree"  name="enter_name_of_tree"  class="form-control " />
                                                        </div>
                                                    </div>
                                                <div class="form-group ">
    ...
    // hide initially
    $("#ctrl-enter_name_of_tree")
        .closest(".form-group")
        .hide()
        .find("input")
        .removeAttr("required");

    $("#ctrl-name_of_tree").on("change", function () {
        ...
        if (val === "other" || val === "others") {
            $("#ctrl-enter_name_of_tree")
                .closest(".form-group")
                .show();
            $("#ctrl-enter_name_of_tree").prop("required", true);
        } else {
            $("#ctrl-enter_name_of_tree")
                .closest(".form-group")
                .hide();
            $("#ctrl-enter_name_of_tree").removeAttr("required");
        }
    });

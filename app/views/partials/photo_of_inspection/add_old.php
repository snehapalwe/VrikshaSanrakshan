...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Photo Of Inspection</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="photo_of_inspection-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("photo_of_inspection/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div id="ctrl-width-holder" class=""> 
                                                        <input id="ctrl-width"  value="<?php  echo $this->set_field_value('width',""); ?>" type="number" placeholder="Enter Width" step="any"  required="" name="width"  class="form-control " />
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label class="control-label" for="height">HEIGHT  </label>
                                                        <div id="ctrl-height-holder" class=""> 
                                                            <input id="ctrl-height"  value="<?php  echo $this->set_field_value('height',""); ?>" type="number" placeholder="Enter Height" step="any"  name="height"  class="form-control " />
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <label class="control-label" for="feet">FEET  </label>
                                                            <div id="ctrl-feet-holder" class=""> 
                                                                <input id="ctrl-feet"  value="<?php  echo $this->set_field_value('feet',""); ?>" type="number" placeholder="Enter Feet" step="any"  name="feet"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>

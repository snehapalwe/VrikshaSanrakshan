                                                                                                                        ...
                                                                                                                        <div class="form-group ">
                                                                                                                            ...
                                                                                                                            <div class="form-group d-none">
                                                                                                                                ...
                                                                                                                                <div id="ctrl-cc_affidavit-holder" class=""> 
                                                                                                                                    <div class="dropzone  " input="#ctrl-cc_affidavit" fieldname="cc_affidavit"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg,.pdf" filesize="3" maximum="1">
                                                                                                                                        <input name="cc_affidavit" id="ctrl-cc_affidavit"  ="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('cc_affidavit',""); ?>" type="text"  />
                                                                                                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please a choose file</div>-->
                                                                                                                                            <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                                                                                                                        </div>
                                                                                                                                    </div>
                                                                                                            ...
                                                                                                            <div class="row ">
                                                                                                                <div class="col-md-12 comp-grid">
                                                                                                                    <div class="">
                                                                                                                        ...
                                                                                                                        <!-- Google Maps JS API -->
                                                                                                                        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCbuXFdCBUA-laYamjRg5MoTcsx8FlUd60&callback=initMap&libraries=&v=weekly" async></script>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>

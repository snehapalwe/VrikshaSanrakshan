...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    ...
                    <!--<strong style='color: black;'>COMMENCEMENT CERTIFICATE</strong>-->
                    <h4 class="record-title"><strong style='color: black;'>COMMENCEMENT CERTIFICATE</strong>  </h4>
                    <br>
                    
                    <?php
                        if(USER_ROLE == 1 || USER_ROLE == 10 || USER_ROLE == 3 || USER_ROLE == 12 || USER_ROLE == 7 || USER_ROLE == 9){
                    ?>
                        <a href="<?php echo SITE_ADDR; ?>commencement_certificate/csv_report" 
        ...
        <?php if(USER_ROLE!=2){ ?>
        <center>
            <a href="<?php echo SITE_ADDR ?>commencement_certificate?status2=pending" class="btn btn-primary">Pending</a>
            <a href="<?php echo SITE_ADDR ?>commencement_certificate?status2=reverted" class="btn btn-danger">Reverted</a>
            <a href="<?php echo SITE_ADDR ?>commencement_certificate?status2=rejected" class="btn btn-danger">Rejected</a>
            <a href="<?php echo SITE_ADDR ?>commencement_certificate?status2=completed" class="btn btn-success">Completed</a>
        </center>
        <?php } ?>
        <div  class="">
            <div class="container-fluid">
                                                        ...
                                                        // echo "<a class='btn btn-sm btn-success' href='" . SITE_ADDR . "payments/view/" . $data['paid_1'] . "'>View Payment Receipt</a><br>"; 
                                                            ...
                                                            // echo "<a class='btn btn-sm btn-info' href='" . SITE_ADDR . "payments/view/" . $data['paid_2'] . "'>View Demand Receipt</a><br>"; 
                                                                ...
                                                                echo "<b><span class='text-danger'>REJECTED</span></b><br>";
                                                                    echo "<a href='".SITE_ADDR."api/viewreason/commencement_certificate/".$data['id']."' class='btn btn-danger page-modal modal-page btn-sm' >VIEW REASON</a>";
                                                                    }
                                                                    
                                                                    if ($x == -100) { 
                                                                    echo "<b><span class='text-danger'>REVERTED</span></b><br>";
                                                                        if (USER_ROLE == 2){
                                                                        echo "<a href='".SITE_ADDR."commencement_certificate/revert/".$data['id']."' class='btn btn-danger' >EDIT</a>";
                                                                        }                                                                       
                                                                        echo "<a href='".SITE_ADDR."api/viewreason/commencement_certificate/".$data['id']."' class='btn btn-primary page-modal modal-page btn-sm'>VIEW REASON</a><br><br>";
}  
                                                                    if ($x == -3) { 
                                                                    echo "<b><span class='text-danger'>REVERTED</span></b><br>";
                                                                        echo "<a href='".SITE_ADDR."commencement_certificate/edit/".$data['id']."' class='btn btn-primary' >EDIT</a>";
                                                                        echo "<a href='".SITE_ADDR."api/viewreason/commencement_certificate/".$data['id']."' class='btn btn-danger page-modal modal-page btn-sm' >VIEW REASON</a>";
                                                                        }
                                                                        if ($x == -1) {
                                                                        echo "<b><span class='text-danger'>UPLOAD TREE PHOTOS</span></b><br>";
                                                                            ...
                                                                            echo "<b><span class='text-danger'>Pending at Garden Inspector - Please visit VVCMC Office for payment</span></b><br>";
                                                                                ...
                                                                                echo "<a class='btn btn-sm btn-danger' href='" . SITE_ADDR . "payments/add3/?db_name=commencement_certificate&rec_id=" . $data['id'] . "&recieved_from=".$data['applicant_full_name']."'>Make Payment</a><br>";
                                                                                    ...
                                                                                    if ($x == 7) {
                                                                                    if (USER_ROLE == 7) {
                                                                                    echo "<br><a class='btn btn-sm btn-warning' href='" . SITE_ADDR . "cc_photo_inspection/list?rec_id=" . $data['id'] . "&edit=1'>View Tree Photo</a>";
                                                                                        if (!isset($data['names_of_trees_be_planted']) || trim($data['names_of_trees_be_planted']) === '') {
                                                                                        echo "<b>Add Tree Photo To Proceed</b><br>";
                                                                                            echo "<a class='btn btn-sm btn-danger' href='" . SITE_ADDR . "accept_reject2/add/?db_name=commencement_certificate&rec_id=" . $data['id'] . "&r=force'>REVERT</a><br>";

                                                                                            echo "<a class='btn btn-sm btn-danger' href='" . SITE_ADDR . "cc_photo_inspection/add?rec_id=" . $data['id'] . "'>Add Photo</a><br>";
                                                                                            
                                                                                                            if ($data['trees_added']+0>0){
                                                                                                    ...
                                                                                                    if (!isset($data['names_of_trees_be_planted']) || trim($data['names_of_trees_be_planted']) === '') {
                                                                                                        ...
                                                                                                        echo "<a class='btn btn-sm btn-success' href='" . SITE_ADDR . "commencement_certificate/tippni/" . $data['id'] . "'>Generate Tippni</a><br>";
                                                                                                            echo "<a href='" . SITE_ADDR . "commencement_certificate/tippni_upload/" . $data['id'] . "' class='btn btn-danger btn-sm'>Upload Tippni </a><br><br>";
                                                                                                                ...
                                                                                                                if (isset($data['tippni_upload']) && trim($data['tippni_upload']) !== '' ) { 
                                                                                                                echo "<a class='btn btn-sm btn-danger' href='" . SITE_ADDR . "accept_reject2/add/?db_name=commencement_certificate&rec_id=" . $data['id'] . "'>APPROVE/REJECTION</a><br>";
                                                                                                                    }
                                                                                                                    }
                                                                                                                    }
                                                                                                                    echo "<br><span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px;'>PENDING AT Garden Inspector</span>";
                                                                                                                    }
                                                                                                                    if($data['tippni_upload']!="" && USER_ROLE!=2){ 
                                                                                                                    echo "<br><a href='" . $data['tippni_upload'] . "' class='btn btn-success btn-sm'>View Tippni </a>";
                                                                                                                        }
                                                                                                                        if ($x == 9) {
                                                                                                                        echo "<br><a class='btn btn-sm btn-warning' href='" . SITE_ADDR . "cc_photo_inspection/list?rec_id=" . $data['id'] . "'>View Tree Photo</a>";
                                                                                                                            if(USER_ROLE==2){
                                                                                                                            if ($data['demand'] == "YES") {
                                                                                                                                        ...
                                                                                                                                        //         echo "<a href='" . SITE_ADDR . "commencement_certificate/tippni_data/" . $data['id'] . "' class='btn btn-danger btn-sm'>Add Tippni Data</a><br>";
                                                                                                                                            ...
                                                                                                                                            //     echo "<a class='btn btn-sm btn-success' href='" . SITE_ADDR . "commencement_certificate/tippni/" . $data['id'] . "'>Generate Tippni</a><br>";
                                                                                                                                                //     echo "<a href='" . SITE_ADDR . "commencement_certificate/tippni_upload/" . $data['id'] . "' class='btn btn-danger btn-sm'>Upload Tippni </a><br><br>";
                                                                                                                                                    ...
                                                                                                                                                    // }
                                                                                                                                                    echo "<a class='btn btn-sm btn-danger' href='" . SITE_ADDR . "accept_reject2/add/?db_name=commencement_certificate&rec_id=" . $data['id'] . "&recommend=true'>RECOMMEND</a><br>";
                                                                                                                                                        }
                                                                                                                                                        }
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    echo "<br><a class='btn btn-sm btn-warning' href='" . SITE_ADDR . "cc_photo_inspection/list?rec_id=" . $data['id'] . "'>View Tree Photo</a>";
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        echo "<a class='btn btn-sm btn-success' href='" . SITE_ADDR . "commencement_certificate/permission/" . $data['id'] . "'>Generate Permission</a><br>";
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            echo "<br><a href='" . $data['permission_upload'] . "' target='_blank' class='btn btn-sm btn-success'>View Permission</a><br>";
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if($cert_up){
                                                                                                                                                                                                                echo "<br><span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px;'>PROCESS COMPLETED</span>";
                                                                                                                                                                                                                }else{
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            <?php
                                                                                                                                                                                                            if (isset($data['inspection_report_by_cg']) && trim($data['inspection_report_by_cg']) !== ''&& trim($data['inspection_report_by_cg']) !== '1')

            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn page-content">
                        ...
                        $application_id = $db->getOne("occupancy_certificate", " oc_application_id");
                        }else{
                        $db->where("id", $data['rec_id']);
                        $application_id = $db->getOne("commencement_certificate", " cc_application_id as oc_application_id");
                        }
                        $data['oc_application_id']=$application_id['oc_application_id'];
                        $subject = "";
                        // Fetch request sub-entry data
                        if ($data['db_name'] == "occupancy_certificate") {
                            ...
                            <head>
                                <meta charset="UTF-8">
                                    ...
                                    <body>
                                        ...
                                        $number = $number % 1000;
                                        if ($thousands <= 19) {
                                        $words .= isset($marathiUnits[$thousands]) ? $marathiUnits[$thousands] . ' ' . $marathiThousands : '';
                                        } else {
                                        $tens = floor($thousands / 10);
                                        $units = $thousands % 10;
                                        $words .= isset($marathiTens[$tens]) ? $marathiTens[$tens] : '';
                                        $words .= ($units && isset($marathiUnits[$units])) ? ' ' . $marathiUnits[$units] : '';
                                        $words .= ' ' . $marathiThousands;
                                        }
                                        }
                                        // Handle hundreds
                                        if ($number >= 100) {
                                                        ...
                                                        <img src="<?php echo SITE_ADDR.SITE_LOGO ?>" class="logo" alt="Logo">
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $data['oc_application_id']; ?></td>

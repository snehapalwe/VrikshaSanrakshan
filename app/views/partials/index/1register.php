            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="user_info-userregister-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="<?php print_link("index/register?csrf_token=$csrf_token") ?>" method="post">
                            <!--[main-form-start]-->
                            <div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-ward-holder" class=""> 
                                                    <select required=""  id="ctrl-ward" name="ward"  placeholder="All"    class="custom-select" >
                                                        <option value="">All</option>
                                                        <?php 
                                                        $ward_options = $comp_model -> user_info_ward_option_list();
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div id="ctrl-mobile_number-holder" class=""> 
                                                    <input id="ctrl-mobile_number"  value="<?php  echo $this->set_field_value('mobile_number',""); ?>" type="text" placeholder="Enter Mobile Number"  required="" name="mobile_number"  class="form-control " />
                                                    </div>
                                                </div>
                                                <div class="form-group ">

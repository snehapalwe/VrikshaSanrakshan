                                            ...
                                            <div class="header-row">
                                                ...
                                                <div class="" >
                                                    ...
                                                    <div class="header-right">
                                                        <p> <STRONG>जा.क्र.कडोंमपा/उद्यान/वृअ/वृप्रा/ <?php echo $data['id']; ?></STRONG></p>
                                                    ...
                                                    <div class="content">
                                                        <p><strong>प्रति,</strong> <br><strong><?php echo $data['applicant_full_name']; ?> </strong><br> <?php echo $data['applicant_address']; ?> </p>
                                                            <p><strong>विषय:</strong> महाराष्ट्र (नागरीक्षेत्र) झाडांचे संरक्षण व जतन अधिनियम 1975 चे प्रकरण 8  कलम 19 (क) मधील तरतुदीनुसार जमीनीच्या विकासासाठी वृक्ष अधिकाऱ्याचा ना हरकत <br>
                                                                ...
                                                                <p> उपरोक्त संदर्भिय पत्र क्र. १ अन्वये आपण बांधकाम परवानगी प्राप्त करणे करिता उद्यान व वृक्ष प्राधिकरण ना हरकत दाखला अपेक्षिला आहे. तद्अनुषंगाने, <?php echo $data['address_of_plot']; ?> (जागेचा पत्ता) या परिसरातील स.नं. /सि.टी.स.नं  <?php echo $data['survey_no']; ?>,  मौजे <?php echo $data['mouje']; ?>  या भूखंडावर दि. <?php echo $inspection['inspection_date']; ?> रोजी पाहणी केली असता, सद्य:स्थितीत सदर भूखंडावर खालीलप्रमाणे झाडे आढळुन आलेली आहेत.  </p>  

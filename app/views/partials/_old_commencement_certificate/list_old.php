                                                        ...
                                                        // echo "<a class='btn btn-sm btn-success' href='" . SITE_ADDR . "payments/view/" . $data['paid_1'] . "'>View Payment Receipt</a><br>"; 
                                                            ...
                                                            // echo "<a class='btn btn-sm btn-info' href='" . SITE_ADDR . "payments/view/" . $data['paid_2'] . "'>View Demand Receipt</a><br>"; 
                                                                ...
                                                                echo "<b><span class='text-danger'>REJECTED</span></b><br>";
                                                                    echo "<a href='".SITE_ADDR."api/viewreason/commencement_certificate/".$data['id']."' class='btn btn-danger' >VIEW REASON</a>";
                                                                    }
                                                                    if ($x == -3) { 
                                                                        ...
                                                                        echo "<b><span class='text-danger'>UPLOAD TREE PHOTOS</span></b><br>";
                                                                            ...
                                                                            echo "<b><span class='text-danger'>Pending at Garden Inspector - Please visit VVCMC Office for payment</span></b><br>";
                                                                                ...
                                                                                echo "<a class='btn btn-sm btn-danger' href='" . SITE_ADDR . "payments/add3/?db_name=commencement_certificate&rec_id=" . $data['id'] . "&recieved_from=".$data['applicant_full_name']."'>Make Payment</a><br>";
                                                                                                                    ...
                                                                                                                    echo " <a href='" . $data['tippni_upload'] . "' class='btn btn-success btn-sm'>View Tippni </a><br> ";
                                                                                                                        }
                                                                                    if ($x == 7) {
                                                                                    if (USER_ROLE == 7) {
                                                                                    echo " <a class='btn btn-sm btn-warning' href='" . SITE_ADDR . "cc_photo_inspection/list?rec_id=" . $data['id'] . "'>View Tree Photo</a><br>";
                                                                                                                                                                                ...
                                                                                                                                                                                echo "<a class='btn btn-sm btn-danger' href='" . SITE_ADDR . "accept_reject2/add/?db_name=commencement_certificate&rec_id=" . $data['id'] . "'>APPROVE/REJECTION</a><br>";
                                                                                                                                                                                    ...
                                                                                                                                                                                    echo " <a class='btn btn-sm btn-warning' href='" . SITE_ADDR . "cc_photo_inspection/list?rec_id=" . $data['id'] . "'>View Tree Photo</a><br>";
                                                                                                                                                                                        ...
                                                                                                                                                                                        echo "<a class='btn btn-sm btn-danger' href='" . SITE_ADDR . "accept_reject2/add/?db_name=commencement_certificate&rec_id=" . $data['id'] . "'>APPROVE/REJECTION</a><br>";
                                                                                                                                                                                            ...
                                                                                                                                                                                            echo "<span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px;'>PENDING AT Chief Garden Superintendent</span>";
                                                                                                                                                                                            }
                                                                                                                                                                                            if (USER_ROLE == 9) {
                                                                                                                                                                                                ...
                                                                                                                                                                                                echo "<a href='" . SITE_ADDR . "commencement_certificate/permission_upload/" . $data['id'] . "' class='btn btn-danger btn-sm'>Upload Permission </a><br>"; 
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    echo " <a class='btn btn-sm btn-warning' href='" . SITE_ADDR . "cc_photo_inspection/list?rec_id=" . $data['id'] . "'>View Tree Photo</a><br>";
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        echo "<a class='btn btn-sm btn-success' href='" . SITE_ADDR . "commencement_certificate/permission/" . $data['id'] . "'>Generate Permission</a><br>";
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            echo " <a href='" . $data['permission_upload'] . "' target='_blank' class='btn btn-sm btn-success'>View Permission</a><br>";
                                                                                                                                                                                                                $cert_up=1;
                                                                                                                                                                                                                }
                                                                                                                                                                                                                if($cert_up){
                                                                                                                                                                                                                echo "<span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px;'>PROCESS COMPLETED</span>";
                                                                                                                                                                                                                }else{
                                                                                                                                                                                                                echo "<span style='font-weight: bold; background-color: yellow; padding: 2px 5px; border-radius: 3px;'>PROCESS COMPLETED - UPLOAD PENDING AT Garden Superintendent</span>";
                                                                                                                                                                                                                }
                                                                                                                                                                                                                }
                                                                                                                                                                                                                ?>
                                                                                                                                                                                                            </span>
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            echo "<br><a href='".$data['inspection_report_by_cg']."' class='btn btn-success'>Inspection Report </a>"; 
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                <div class="mb-2" style="display: flex; justify-content: space-between; align-items: center;">
                                                                                                                                                                                                                    <strong style="font-weight: 500 !important; color: #000 !important;">
                                                                                                                                                                                                                        PHYSICAL COLORED MAP WITH TREE LOCATED:
                                                                                                                                                                                                                    </strong>  

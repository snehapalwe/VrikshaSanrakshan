            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn page-content">
                        ...
                        <div id="main" class>
                            <div id="printarea"   >
                            <div id="printable-section" style="border:1px solid black;padding:50px" >
                                            ...
                                            * {
                                            ...
                                            margin-bottom: 5px;
                                                ...
                                                <p><h1>कल्याण डोंबिवली महानगरपालिका <br> कल्याण उद्यान व वृक्ष प्राधिकरण विभाग</h1></p>
                                                    ...
                                                    <p class="head_content"><strong>दिनांक:</strong> <?php echo date('jS F Y', strtotime($data['updated_timestamp'])); ?></p>
                                                    ...
                                                    <ol>
                                                        ...
                                                        <li>विकासक यांचा विहीत नमुन्यातील , दि. <?php echo date('jS F Y', strtotime($data['date'])); ?> रोजीचा प्राप्त अर्ज.
